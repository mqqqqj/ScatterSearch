...
"$L_str" 100 /SSD/Text-to-Image/gt.10K_10M.bin t2i | tee -a /home/mqj/proj/ANNSLib/observation/t2i_sequential_two_stage_ndc.csv
...
# "$L_str" 100 /SSD/LAION/gt.test50K.bin laion | tee -a /home/mqj/proj/ANNSLib/observation/laion_sequential_two_stage_ndc.csv
...
# "$L_str" 100 /SSD/DEEP10M/gt.query.top100.bin deep | tee -a /home/mqj/proj/ANNSLib/observation/deep_sequential_two_stage_ndc.csv

...
# L_list=(300 350 400 450 500 550 600 800 1000 1100 1200 1300 1400 1500 1600 1800 1900 2100 2300 2500 2700 2900 3000)

# laion
# L_list=(100 200 300 350 400 450 500 550 600 800 1000 1100 1200 1300 1400 1500 1600 1800 1900 2100 2300 2500 2700 2900 3000 3200 3400 3600 3800)
...
# "$L_str" 100 "$thread_num" /SSD/LAION/gt.test50K.bin "laion" | tee -a /home/mqj/proj/ANNSLib/experiments/laion_16t_edgewise.csv

#glove
# L_list=(100 200 300 350 400 450 500 550 600 800 1000 1100 1200 1300 1400 1500 1600 1800 1900 2100 2300 2500 2700 2900 3000 3200 3400 3600 3800 4000 4200)
# L_str=$(IFS=,; echo "${L_list[*]}")
...
# "$L_str" 100 "$thread_num" /SSD/Glove200/gt.query.top100.bin "glove" | tee -a /home/mqj/proj/ANNSLib/experiments/glove_16t_edgewise.csv
...
"$L_str" 100 "$thread_num" /SSD/MainSearch/gt.test_unique.bin "mainsearch" #| tee -a /home/mqj/proj/ANNSLib/experiments/mainsearch_16t_edgewise.csv

#text-to-image
# L_list=(1700 1750 1800)
# L_str=$(IFS=,; echo "${L_list[*]}")
...
# "$L_str" 100 "$thread_num" /SSD/Text-to-Image/gt.10K_10M.bin "t2i" #| tee -a /home/mqj/proj/ANNSLib/experiments/t2i_16t_edgewise.csv
...
# "$L_str" 100 "$thread_num" /SSD/WebVid/gt.query.top100.bin "webvid" | tee -a /home/mqj/proj/ANNSLib/experiments/webvid_16t_edgewise.csv
...
# "$L_str" 100 "$thread_num" /SSD/OpenAI-1M/groundtruth.bin "gist" | tee -a /home/mqj/proj/ANNSLib/experiments/openai_8t_edgewise.csv
